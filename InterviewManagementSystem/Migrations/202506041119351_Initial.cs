    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Interviewers", t => t.InterviewerId, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        Status = c.String(),
                        MaxPositionsOpen = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Interviews", "InterviewerId", "dbo.Interviewers");
